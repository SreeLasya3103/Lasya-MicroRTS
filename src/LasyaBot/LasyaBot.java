...
public class LasyaBot extends AbstractionLayerAI {
...
private void addUnitToLists(Unit unit, List<Unit>... lists) {
    ...
    public LasyaBot(UnitTypeTable unitTypeTable) {
        this(unitTypeTable, new AStarPathFinding());
    }

    public LasyaBot(UnitTypeTable unitTypeTable, PathFinding pf) {
        super(pf);
    ...
    @Override
    public AI clone() {
        return new LasyaBot(unitTypeTable, pf);
    }
